...
7. Follow the installation steps as displayed here: https://docs.ros.org/en/humble/Installation/Ubuntu-Install-Debs.html. Some of the packages
that are required are not included in the ros humble image from docker so this will ensure that you have the required base packages.
